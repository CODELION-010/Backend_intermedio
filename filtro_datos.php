...
<head>
    ...
    <link rel="icon" href="img/filtro_datos.png">
    <link rel="stylesheet" href="css/filtro_datos.css">
    <title>Table db</title>
</head>
<body>
<a href="index.html#menu"><button type="button" id="btn_menu">Ir al menú</button></a>
    <a href="index.html"><button type="button" id="btn_menu">Final</button></a>

<div class="wrapper">
    <div class="container">
    <h3>Selecciona cantidad de registros mostrado en la tabla</h3>
            <div class="filter">
            <div class="row">
                <div class="col-sm-4">
                <div class="show-row">
                ...
                <div class="search-row">
                    <input type="text" name="search" class="form-control" placeholder="Buscar por letra o nombre">
                </div>
                </div>
            </div>
            </div>
