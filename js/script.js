//Saludo y descripcion usando javascripr
window.addEventListener('DOMContentLoaded', function() {
  var textoSalida = document.getElementById('texto-salida');
  var textoPredefinido = 
'¡Hola! Prófesor Andres Pineda, Bienvenido a mi Proyecto Backend de Full Stack.\n'
  + 'nivel intermedio, maquete algo interactivo e intuitivo,\n'
...
//fragmento para filtro de datos
